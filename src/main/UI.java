...
//    public boolean gameFinished = false;
    ...
    public UI(GamePanel gp) {
        ...
        try {
            InputStream is = Objects.requireNonNull(getClass().getResourceAsStream("/font/MaruMonica.ttf"));
            maruMonica = Font.createFont(Font.TRUETYPE_FONT, is);
            is = Objects.requireNonNull(getClass().getResourceAsStream("/font/PurisaBold.ttf"));
...
//            currentDialogue = npc.dialogues[npc.dialogueSet][npc.dialogueIndex];
    ...
    public void drawCharacterScreen() {
        ...
        value = String.valueOf(gp.player.level); // Level
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;

        value = gp.player.life + "/" + gp.player.maxLife; // Life
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;

        value = gp.player.mana + "/" + gp.player.maxMana; // Life
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;

        value = String.valueOf(gp.player.strength); // Strength
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;

        value = String.valueOf(gp.player.dexterity); // Dexterity
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;

        value = String.valueOf(gp.player.attack); // Attack
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;

        value = String.valueOf(gp.player.defense); // Defense
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;

        value = String.valueOf(gp.player.exp); // Exp
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;

        value = String.valueOf(gp.player.nextLevelExp); // Next Level
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;

        value = String.valueOf(gp.player.coin); // Coin
        textX = getXForAlignToRightText(value, tailX);
        g2.drawString(value, textX, textY);
        textY += lineHeight;
